...
import { recipes, categories, odprti } from './dataArrays';
...
export function addOpenProduct(id,rcipeId,title,photo_url,rok) {
  odprti.push({id: id, recipeId: rcipeId, title: title, photo_url: photo_url, rok: rok});
}
